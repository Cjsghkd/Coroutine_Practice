...
fun main() = runBlocking {
    val elapsedTime = measureTimeMillis {
        val value1 = async(start = CoroutineStart.LAZY) { com.example.coroutine_practice.ch_1.ch_1_4.getRandom5() } // LAZY 이기 때문
        val value2 = async(start = CoroutineStart.LAZY) { com.example.coroutine_practice.ch_1.ch_1_4.getRandom6() }
